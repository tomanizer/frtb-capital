...
_AggregationConfigFn = Callable[[CvaRegulatoryProfile | str], "SaCvaAggregationConfig"]
...
def sa_cva_aggregation_config(
    ...
    *,
    ...
    registry: dict[tuple[SaCvaRiskClass, SaCvaRiskMeasure], _AggregationConfigFn] = {
        ...
        (SaCvaRiskClass.COMMODITY, SaCvaRiskMeasure.DELTA): _commodity_delta_config_for,
        (SaCvaRiskClass.COMMODITY, SaCvaRiskMeasure.VEGA): _commodity_vega_config_for,
    }
