...
class EntityBatchSpec(Generic[T]):
    ...
    def required_columns(self) -> tuple[str, ...]:
        ...
        -------
        tuple[str, ...]
            Ordered required column names from ``column_specs``.
        """
    ...
    def optional_columns(self) -> tuple[str, ...]:
        ...
        -------
        tuple[str, ...]
            Ordered optional column names from ``column_specs``.
        """
...
_CVA_NETTING_SET_BATCH_COLUMN_ARGS: Mapping[str, str] = {
    ...
    "exposure_time_series_id": "exposure_time_series_ids",
    "lineage_source_system": "lineage_source_systems",
    "lineage_source_file": "lineage_source_files",
    "lineage_source_row_id": "lineage_source_row_ids",
}
...
_SA_CVA_SENSITIVITY_BATCH_COLUMN_ARGS: Mapping[str, str] = {
    ...
    "volatility_surface_id": "volatility_surface_ids",
    "volatility_surface_point_id": "volatility_surface_point_ids",
    "shock_id": "shock_ids",
    "hedge_id": "hedge_ids",
