...
def build_cva_netting_set_batch_from_columns(
    *,
    ...
    exposure_time_series_ids: ColumnInput | None = None,
    ...
    _require_netting_lengths(
        ...
        exposure_time_series_ids=exposure_time_series_ids,
...
def _require_netting_lengths(
    ...
    *,
    ...
    exposure_time_series_ids: ColumnInput | None,
...
def _netting_batch_fields(
    *,
    ...
    return {
        ...
        "exposure_time_series_ids": _optional_text_array(
            exposure_time_series_ids, row_count, copy=copy_arrays
        ),
    }
