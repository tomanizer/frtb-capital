...
| `rfet_evidence.py` | RFET evidence assessment with eligible/excluded observation audit trail, source presence checks, bucket representativeness, one-count-per-date, official-holiday/non-business-date exclusions, calendar metadata, and opt-in new-issuance prorating. | MAR31 RFET and real-price evidence for modellability. | Proposed real-price evidence and Type A / Type B NMRF modelling choices. | Article 325be and Delegated Regulation (EU) 2022/2060 comparison gap. | Partial evidence engine; vendor reliance, data-pooling, and supervisor overrides remain open. |
