...
def position_payload(position: RraoPosition) -> dict[str, object]:
    ...
    return position_payload_from_values(
        ...
        has_multiple_strikes_or_barrier=position.has_multiple_strikes_or_barriers,
...
def batch_position_payload(
    *,
    ...
    has_multiple_strikes_or_barrier: object,
    is_ctp_hedge: object,
    ...
    return position_payload_from_values(
        ...
        has_multiple_strikes_or_barrier=has_multiple_strikes_or_barrier,
...
def position_payload_from_values(
    *,
    ...
    payload: dict[str, object] = {
        ...
        "has_maturity": has_maturity,
        "has_strike_or_barrier": has_strike_or_barrier,
        "has_multiple_strikes_or_barriers": has_multiple_strikes_or_barrier,
