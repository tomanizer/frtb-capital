...
| `reference_data.py` | Risk weights, evidence categories, investment-fund inclusion rules, exclusion reason tables, and citation ids. | MAR23.2-MAR23.8. | Proposed section `__.205(e)(3)(iii)` and `__.211(a)`-`__.211(c)`. | Delegated Regulation 2022/2328 Articles 1-3 and Annex. | Implemented cited lookup tables for Basel MAR23 and U.S. NPR 2.0; EU table remains unsupported. |
| `classification.py` | Cited classification, investment-fund inclusion, and exclusion decisions for canonical positions. | MAR23.2-MAR23.7. | Proposed section `__.205(e)(3)(iii)` and `__.211(a)`-`__.211(b)`. | Delegated Regulation 2022/2328 Articles 1-3 and Annex. | Implemented for Basel MAR23 and U.S. NPR 2.0 canonical evidence; exact match-group validation remains future work. |
