...
| `data_models.py` | Frozen input, classification, capital-line, subtotal, result, citation, and lineage dataclasses. | MAR23.1-MAR23.8. | Proposed section `__.211(a)`-`__.211(c)`. | Article 325u; Delegated Regulation 2022/2328 Articles 1-3 and Annex. | Planned in issue #82. |
| `validation.py` | Input invariants, gross effective notional checks, duplicate identity checks, and explicit package input errors. | MAR23.8 gross notional mechanics. | Proposed section `__.211(c)(2)` gross effective notional. | Article 325u comparison only. | Planned in issue #82. |
| `regimes.py` | Rule-profile identity, support declarations, profile status, and profile hash. | MAR23 profile for Basel RRAO mechanics. | Proposed section `__.211` U.S. profile. | Article 325u and Delegated Regulation 2022/2328 EU profile. | Planned in issue #83; EU/PRA capital unsupported until tests exist. |
| `reference_data.py` | Risk weights, evidence categories, exclusion reason tables, and citation ids. | MAR23.2-MAR23.8. | Proposed section `__.211(a)`-`__.211(c)`. | Delegated Regulation 2022/2328 Articles 1-3 and Annex. | Planned in issue #83. |
