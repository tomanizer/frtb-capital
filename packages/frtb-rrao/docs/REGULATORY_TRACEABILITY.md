...
| `capital.py` | Additive line add-ons, zero-capital excluded lines, deterministic subtotals, and included-line total helper. | MAR23.8. | Proposed section `__.211(c)`. | Article 325u comparison mechanics once mapped. | Implemented below the public API; audit result assembly remains issue #87. |
