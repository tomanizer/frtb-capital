...
US_NPR_2_0_CITATIONS: dict[str, SbmCitation] = {
    ...
    "us_npr_91_fr_14952_va7a_fx_vega_option_tenors": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15020, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX vega option-tenor correlation treatment for the NPR comparison slice.",
    ),
    "us_npr_91_fr_14952_va7a_fx_vega_lh_rw": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15020, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX vega liquidity-horizon scaling and risk-weight treatment.",
    ),
    "us_npr_91_fr_14952_va7a_fx_vega_intra": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15020, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX vega same-bucket option-tenor and corresponding-delta correlation treatment.",
    ),
    "us_npr_91_fr_14952_va7a_fx_vega_inter": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15020, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX vega cross-bucket correlation treatment used by the NPR comparison slice.",
    ),
    "us_npr_91_fr_14952_va7a_fx_curvature_factors": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15037-15038, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX curvature sensitivity and risk-factor treatment for the NPR comparison slice.",
    ),
    "us_npr_91_fr_14952_va7a_fx_curvature_shocks": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15037-15038, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX curvature upward/downward shock and delta-risk-weight treatment.",
    ),
    "us_npr_91_fr_14952_va7a_fx_curvature_intra": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15038, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX curvature intra-bucket aggregation and correlation treatment.",
    ),
    "us_npr_91_fr_14952_va7a_fx_curvature_inter": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15038, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX curvature inter-bucket aggregation and correlation treatment.",
    ),
    "us_npr_91_fr_14952_va7a_fx_curvature_scenarios": SbmCitation(
        source_id="us_npr_2_0_91_fr_14952",
        location="91 FR 15038, section V.A.7.a",
        url=US_NPR_2_0_URL,
        note="FX curvature low, medium, and high correlation scenario selection.",
    ),
