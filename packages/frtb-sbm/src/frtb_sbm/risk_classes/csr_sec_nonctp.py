...
def calculate_csr_sec_nonctp_delta_risk_class_capital(
    ...
    *,
    ...
    batch = build_sbm_batch(sensitivities, SbmRiskClass.CSR_SEC_NONCTP, SbmRiskMeasure.DELTA)
...
def aggregate_csr_sec_nonctp_delta_measure_capital(
    ...
    *,
    ...
    Parameters
    ----------
    weighted, profile_id, tranche_by_id, tenor_by_id, risk_factor_by_id, pairwise_evidence_mode,
...
def build_csr_sec_nonctp_delta_intra_bucket_correlation_matrix(
    ...
    *,
    ...
    Parameters
    ----------
    ordered, profile_id, bucket_id, tranche_by_id, tenor_by_id, risk_factor_by_id :
        See function signature for types and defaults.
