    ...
    payload.update(
        {
            "girr_vega_parameters": {
                ...
                "liquidity_horizon_citation_id": profile_citation_id(
                    profile,
                    "basel_mar21_92",
                ),
                "intra_bucket_citation_id": profile_citation_id(
                    profile,
                    "basel_mar21_93",
                ),
            },
...
def _add_non_girr_vega_payload(payload: dict[str, object], profile: SbmRegulatoryProfile) -> None:
    ...
    payload["non_girr_vega_parameters"] = {
        ...
        "risk_weight_factor": GIRR_VEGA_RISK_WEIGHT_FACTOR,
        "risk_weight_cap": GIRR_VEGA_RISK_WEIGHT_CAP,
        "intra_bucket_citation_id": profile_citation_id(profile, "basel_mar21_94"),
        "inter_bucket_citation_id": profile_citation_id(profile, "basel_mar21_95"),
    }
    ...
    payload.update(
        {
            ...
            "fx_delta_parameters": {
                ...
                "risk_weight_citation_id": profile_citation_id(profile, "basel_mar21_87"),
                "sqrt2_citation_id": profile_citation_id(profile, "basel_mar21_88"),
                "inter_bucket_citation_id": profile_citation_id(profile, "basel_mar21_89"),
            },
...
def _add_basel_curvature_and_non_girr_payloads(
    ...
    payload["curvature_parameters"] = {
        ...
        "fx_equity_rule_citation_id": profile_citation_id(profile, "basel_mar21_98"),
        "parallel_shift_rule_citation_id": profile_citation_id(profile, "basel_mar21_99"),
        "intra_bucket_correlation_citation_id": profile_citation_id(profile, "basel_mar21_100"),
        "inter_bucket_correlation_citation_id": profile_citation_id(profile, "basel_mar21_101"),
    }
