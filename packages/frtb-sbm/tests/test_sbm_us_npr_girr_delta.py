...
def test_us_npr_girr_delta_fixture_matches_expected_outputs() -> None:
...
def test_us_npr_girr_delta_batch_and_arrow_match_row_result() -> None:
    loader = load_fixture_module()
    context = loader.load_fixture_context()
    sensitivities = loader.load_fixture_sensitivities()
...
def test_us_npr_unsupported_fixture_cases_fail_closed(
    case_id: str,
