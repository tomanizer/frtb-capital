...
FIXTURE_DIR = Path(__file__).parent / "fixtures" / "girr_delta_eu_crr3_v1"
...
def test_eu_crr3_girr_delta_fixture_matches_expected_outputs() -> None:
...
def test_eu_crr3_girr_delta_batch_and_arrow_match_row_result() -> None:
    loader = load_fixture_module()
    context = loader.load_fixture_context()
    sensitivities = loader.load_fixture_sensitivities()
...
def test_eu_crr3_unsupported_fixture_cases_fail_closed(
    case_id: str,
