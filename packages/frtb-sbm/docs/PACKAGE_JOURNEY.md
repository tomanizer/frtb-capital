...
| `PRA_UK_CRR` comparison profile | GIRR delta/vega/curvature, reporting-currency FX delta/vega/curvature, equity delta, and commodity delta implemented under audit; CSR and remaining PRA cells fail closed with `UnsupportedRegulatoryFeatureError` |
