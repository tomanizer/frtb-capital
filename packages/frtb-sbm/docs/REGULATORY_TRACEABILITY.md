...
| --- | --- | --- |
| Package scaffold and public boundary | Partial | `calculate_sbm_capital` produces capital for supported GIRR delta/vega, non-credit delta, CSR delta, and curvature inputs. |
...
| `reference_data.py` | Risk-class bucket definitions, tenor sets, risk weights, correlations, scenario labels, and citation ids. | MAR21 risk-class tables, including MAR21.96-MAR21.101 curvature weights and correlations. | Section V.A.7.a risk-weight and correlation steps. | Implemented for GIRR, FX, equity, commodity, and CSR delta/curvature reference data. |
