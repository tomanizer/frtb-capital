...
| --- | --- | --- |
| Package scaffold and public boundary | Partial | `calculate_sbm_capital` produces capital for supported GIRR delta/vega, non-credit delta, and CSR delta inputs. |
...
| Curvature contracts | Partial | #165 — row-wise `curvature.py` validates up/down shock inputs. #289 adds a GIRR curvature Arrow/batch validation handoff that preserves separate up/down shock arrays; capital remains unsupported. |
...
| `curvature.py` | Curvature input contracts, up/down shock validation, GIRR CVR+/CVR- branch engine, bucket branch audit records, and fail-closed public capital gates. | MAR21.5 and MAR21.100-MAR21.101 curvature provisions. | Section V.A.7.a footnote 328. | Partial — GIRR MAR21.5 engine implemented for direct calculation (#252), but public curvature capital remains fail-closed pending full curvature reference-data coverage (#253). |
