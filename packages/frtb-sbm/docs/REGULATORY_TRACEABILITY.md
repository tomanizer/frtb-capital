...
`EU_CRR3` cells, and `PRA_UK_CRR` GIRR delta, every risk-class and measure
combination for
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GIRR | implemented under audit | implemented under audit | implemented under audit | implemented under audit | implemented under audit | implemented under audit | implemented under audit | unsupported fail-closed | unsupported fail-closed |
