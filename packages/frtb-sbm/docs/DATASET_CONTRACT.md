...
delta, GIRR vega, and GIRR curvature comparison fixtures. Unsupported profiles or unsupported
sub-features must fail closed through package errors before any capital result
is emitted.
