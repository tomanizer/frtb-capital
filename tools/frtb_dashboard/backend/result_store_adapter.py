"""Result-store backed adapter for the FRTB Capital Navigator dashboard."""
...
class ResultStoreAdapter:
    ...
    def _summary_for_run(self, run: Any) -> RunSummary:
        ...
        return RunSummary(
            run_id=_DASHBOARD_RUN_ID,
            label="Capital Navigator result-store fixture",
...
def _fixture_store() -> DuckDbParquetResultStore:
    fixture_root = Path(tempfile.gettempdir()) / "frtb-dashboard-result-store-fixture"
