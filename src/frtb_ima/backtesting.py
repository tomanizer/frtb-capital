...
def trading_desk_backtest(
    ...
    for confidence_level, limit in exception_limits:
        ...
        apl_exceptions = _count_exceptions_regulatory(apl_w, var_w, holiday_w)
        hpl_exceptions = _count_exceptions_regulatory(hpl_w, var_w, holiday_w)
