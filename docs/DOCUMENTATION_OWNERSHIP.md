...
| Visuals, diagrams, and notebook chart style | [visuals.md](visuals.md) | Package notebook READMEs, package journeys, [CLIENT_INTEGRATION.md](CLIENT_INTEGRATION.md), and contributor docs | Suite documentation maintainers for the standard; package maintainers for package-local notebook visuals. |
