...
| Earlier phase | Established CVA planning documents, requirements registry, public API, and fixture workflows. | `docs/modules/frtb-cva/README.md`; `docs/modules/frtb-cva/requirements/BASEL_FRTB_CVA.yml`. |
