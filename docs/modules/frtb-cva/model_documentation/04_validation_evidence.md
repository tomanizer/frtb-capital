...
- `test_cva_regimes.py`, `test_cva_reference_data.py`, and
  `test_cva_support_matrix.py` check profile hashes, profile-specific citation
  maps, supported profile/method/path rows, and fail-closed unsupported cells.
