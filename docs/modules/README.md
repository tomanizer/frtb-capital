...
| DRC | Partial runtime; non-securitisation, securitisation non-CTP, and CTP row paths implemented | [frtb-drc/README.md](frtb-drc/README.md) | [frtb-drc/REGULATORY_REQUIREMENTS.md](frtb-drc/REGULATORY_REQUIREMENTS.md) | [frtb-drc/PRD.md](frtb-drc/PRD.md) | [packages/frtb-drc/docs/requirements/BASEL_FRTB_DRC.yml](../../packages/frtb-drc/docs/requirements/BASEL_FRTB_DRC.yml) |
