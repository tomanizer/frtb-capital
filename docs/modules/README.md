...
| IMA | Implemented | [frtb-ima/README.md](frtb-ima/README.md) | [frtb-ima/REGULATORY_REQUIREMENTS.md](frtb-ima/REGULATORY_REQUIREMENTS.md) | [frtb-ima/PRD.md](frtb-ima/PRD.md) | [frtb-ima/PUBLIC_API.md](frtb-ima/PUBLIC_API.md) |
| SBM | Partial runtime; BASEL_MAR21 delta, vega, and curvature across all seven risk classes (row, batch, and Arrow paths) | [frtb-sbm/README.md](frtb-sbm/README.md) | [frtb-sbm/REGULATORY_REQUIREMENTS.md](frtb-sbm/REGULATORY_REQUIREMENTS.md) | [frtb-sbm/PRD.md](frtb-sbm/PRD.md) | [frtb-sbm/requirements/BASEL_FRTB_SBM.yml](frtb-sbm/requirements/BASEL_FRTB_SBM.yml) |
...
| Orchestration | Implemented for suite arithmetic, SA composition, IMA and CVA summary handoffs, jurisdiction-family guards, and top-of-house aggregation | [frtb-orchestration/README.md](frtb-orchestration/README.md) | [frtb-orchestration crosswalk](../regulatory/crosswalk/frtb-orchestration.yml) | N/A | N/A |
