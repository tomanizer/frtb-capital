...
- Validation status: import smoke, explicit failure paths, SA component handoff
...
Approach stack. Orchestration consumes only the typed handoff — there are no
duck-typing `recognise_*` helpers and no reach into raw component result
