...
| Local reference implementation | External `extract_cva` capital navigator, SBM component | Implementation inspiration for component graph, CRIF mappings, risk-class modules, correlation scenarios, and outputs; not included in this repository. |
