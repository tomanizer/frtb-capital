...
banking-book securitisation mappings, fair-value-cap handling, and internal
decomposition contracts. U.S. NPR 2.0 securitisation non-CTP and CTP paths can
consume typed `DrcRiskWeightEvidence` records carrying source profile, source
table, source method, effective risk weight, lineage, and citations. EU CRR3
and UK PRA profiles are known but fail closed pending Article 325w / PRA PS1/26
rulebook mappings.
