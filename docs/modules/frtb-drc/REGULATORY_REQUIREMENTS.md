...
category, and fair-value-cap evidence. PRA UK CRR CTP remains fail closed
until PRA-owned reference data, deterministic fixtures, and support-matrix
tests land.
