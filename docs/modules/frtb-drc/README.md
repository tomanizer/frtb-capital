...
- Implementation status: partial runtime; supported non-securitisation, securitisation non-CTP, and CTP row paths
...
inputs. The current runtime covers gross JTD, maturity scaling,
