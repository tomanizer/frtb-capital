...
- Implementation status: partial runtime; supported non-securitisation path only
- Validation status: pending

The package is importable and exposes `calculate_drc_capital` for supported
U.S. NPR 2.0 non-securitisation canonical inputs. The current runtime covers
gross JTD, maturity scaling, seniority-aware netting, hedge benefit ratio,
bucket/category capital, reconciliation, and attribution-ready audit lineage.
Securitisation non-CTP and CTP paths fail closed until separately implemented.
