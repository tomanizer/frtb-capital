...
- `test_drc_securitisation.py` and `test_drc_ctp.py` cover the supported U.S.
  securitisation non-CTP and CTP paths plus fail-closed evidence gaps.
- `test_drc_regimes.py` checks Basel MAR22 non-securitisation support and
  explicit Basel MAR22 securitisation/CTP unsupported messages.
