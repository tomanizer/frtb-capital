...
| Earlier phase | Established the DRC planning pack, public API, requirements registry, synthetic fixtures, audit/replay, and explicit unsupported gates. | `docs/modules/frtb-drc/README.md`; `docs/modules/frtb-drc/requirements/BASEL_FRTB_DRC.yml`. |
