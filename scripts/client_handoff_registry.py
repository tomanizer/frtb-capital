...
def handoff_registry() -> Mapping[tuple[str, str], HandoffEntry]:
    ...
    entries = (
        HandoffEntry(
            package="frtb_drc",
            handoff_id="nonsec",
            column_specs=frtb_drc.DRC_NONSEC_HANDOFF_COLUMN_SPECS,
        ...
        HandoffEntry(
            ...
            column_specs=frtb_drc.DRC_SECURITISATION_NON_CTP_HANDOFF_COLUMN_SPECS,
            normalize=frtb_drc.normalize_drc_securitisation_non_ctp_arrow_table,
            build_batch=frtb_drc.build_drc_securitisation_non_ctp_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_drc",
            handoff_id="ctp",
            column_specs=frtb_drc.DRC_CTP_HANDOFF_COLUMN_SPECS,
            normalize=frtb_drc.normalize_drc_ctp_arrow_table,
            build_batch=frtb_drc.build_drc_ctp_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_rrao",
            handoff_id="positions",
            column_specs=frtb_rrao.RRAO_HANDOFF_COLUMN_SPECS,
        ...
        HandoffEntry(
            ...
            column_specs=frtb_cva.CVA_COUNTERPARTY_HANDOFF_COLUMN_SPECS,
            normalize=frtb_cva.normalize_cva_counterparty_arrow_table,
            build_batch=frtb_cva.build_cva_counterparty_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_cva",
            handoff_id="netting_set",
            column_specs=frtb_cva.CVA_NETTING_SET_HANDOFF_COLUMN_SPECS,
            normalize=frtb_cva.normalize_cva_netting_set_arrow_table,
            build_batch=frtb_cva.build_cva_netting_set_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_sbm",
            handoff_id="girr_delta",
            column_specs=frtb_sbm.GIRR_DELTA_HANDOFF_COLUMN_SPECS,
            normalize=frtb_sbm.normalize_girr_delta_arrow_table,
            build_batch=frtb_sbm.build_girr_delta_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_ima",
            handoff_id="scenario_metadata",
            column_specs=frtb_ima.IMA_SCENARIO_METADATA_HANDOFF_COLUMN_SPECS,
            normalize=frtb_ima.normalize_ima_scenario_metadata_arrow_table,
            build_batch=frtb_ima.build_scenario_metadata_batch_from_handoff,
        ),
        HandoffEntry(
            package="frtb_ima",
            handoff_id="rfet_observation",
            column_specs=frtb_ima.IMA_RFET_OBSERVATION_HANDOFF_COLUMN_SPECS,
            normalize=frtb_ima.normalize_ima_rfet_observation_arrow_table,
            build_batch=frtb_ima.build_rfet_observation_batch_from_handoff,
        ),
    )
